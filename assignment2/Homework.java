...
class Homework {
  ...
  public static String IDENT = "Jing";
  public static String PASSWORD = "EYES_ARE_BLUE";
  ...
  public static void main(String[] args) {
    if (args.length != 3) {
      Homework hw = new Homework(IDENT, PASSWORD);
...
//      System.out.println("Usage: java Homework monitor monitor-port ident");
      ...
      Homework hw = new Homework(args[2], PASSWORD);
      hw.ac.start(); //Start the Active Client
      hw.s.start();  //Start the Server
      }
   }       
